...
VERSION = "1.0.0"
DESCRIPTION = "This game is support for two player. The player win if there exist connection of five piece."
PLAYERS = 2
...
from logic_player import run_player_game
from logic_server import run_server_game
...
class Game:
    ...
    def player_start(self):
        ...
        run_player_game(server_ip=SERVER_HOST, server_port=SERVER_PORT)
        
    def server_start(self):
        # TODO: developer need to call server side function
        run_server_game(server_host=SERVER_HOST, server_port=SERVER_PORT)
